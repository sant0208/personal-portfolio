...
const About = () => {
  return (
    <div>
      ...
      >
        I'm a third-year Computer Science Engineering student at RMK College of Engineering 
        And Technology. I'm interested indesigning user-friendly websites that are both 
        simple and elegant . I'm a quick learner and collaborate closely with clients to
